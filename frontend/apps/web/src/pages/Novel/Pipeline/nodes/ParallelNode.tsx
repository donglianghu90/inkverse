...
export function ParallelForkNode({ data, selected }: NodeProps<ParallelNodeData>) {
  return (
    <div className={cn(
      ...
      <Handle type="target" position={Position.Top} id="top" className="!w-3 !h-3 !bg-teal-400/50 !border-2 !border-background" />
      ...
      <Handle type="source" position={Position.Bottom} id="bottom" className="!w-3 !h-3 !bg-teal-400/50 !border-2 !border-background" />
      <Handle type="source" position={Position.Left} id="left" className="!w-2.5 !h-2.5 !bg-teal-400/50 !border-2 !border-background" />
      <Handle type="source" position={Position.Right} id="right" className="!w-2.5 !h-2.5 !bg-teal-400/50 !border-2 !border-background" />
    </div>
  );
}
...
export function ParallelJoinNode({ data, selected }: NodeProps<ParallelNodeData>) {
  return (
    <div className={cn(
      ...
      <Handle type="target" position={Position.Top} id="top" className="!w-3 !h-3 !bg-teal-400/50 !border-2 !border-background" />
      <Handle type="target" position={Position.Left} id="left" className="!w-2.5 !h-2.5 !bg-teal-400/50 !border-2 !border-background" />
      <Handle type="target" position={Position.Right} id="right" className="!w-2.5 !h-2.5 !bg-teal-400/50 !border-2 !border-background" />
