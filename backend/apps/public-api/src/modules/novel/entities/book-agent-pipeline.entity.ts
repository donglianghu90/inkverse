...
export const DEFAULT_PIPELINE_NODES: AgentNodeConfig[] = [
  ...
  { id: 'scene-planner', type: 'scene-planner', label: '场景规划', description: '将章节意图拆分为3-5个独立场景，每个有独立视角、情绪弧和叙事任务', isEnabled: true, isDeletable: false, isCore: false, position: 3, rfPosition: { x: 300, y: 480 }, additionalSystemPrompt: '' },
